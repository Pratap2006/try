...
speed = prompt("You must have entered something, the default will be: " + lastSpeed, [lastSpeed]);
speed = lastSpeed

}else{
speed = prompt("You entered the wrong thing at all, select the speed min, mid, max", [lastSpeed]);
speed = lastSpeed
}
};
